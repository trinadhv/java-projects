...
public class Tms {
    ...
    private JComboBox editDriverNames,deleteDriverNames,addAssignDriverNames,editAssignDriverNames,editGender,selectVehicleNames,deleteVehicleNames;
	...
	private void initialize() {
		...
		btnAddVehicle.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				else if(addAssignDriverNames.getSelectedItem().toString().length()==0)
				{
					...
					showErrorMessage("Please Assign a driver to this vehicle. \nWe discourage automatic driving vehicles");
				}
				else{
					
					//all validations passed
					dbmanager.addVehicle(addVehicleName.getText(), Long.parseLong(addRegNo.getText()), Integer.parseInt(addCapacity.getText()), addVtype.getText(),addAssignDriverNames.getSelectedItem().toString());
				}
		...
		btnAddDriver.addActionListener(new ActionListener() {
			...
			dbmanager.addDriver(addDriverName.getText(), Long.parseLong(addLicense.getText()), addGender.getSelectedItem().toString(),Long.parseLong(addContact.getText()));
		...
		btnSaveDriver.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				dbmanager.editDriver(editDriverNames.getSelectedItem().toString(),editDriverName.getText(), Long.parseLong(editLicenseNo.getText()), editGender.getSelectedItem().toString(),Long.parseLong(editContact.getText()));
		...
		iconLabel.setIcon(new ImageIcon("H:\\workspace\\Transport Management System\\src\\tms\\University_of_Bridgeport.svg.png"));
