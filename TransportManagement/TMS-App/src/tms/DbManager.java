...
public class DbManager {
	...
	public void addDriver(String dname, long license, String gender, long contact) {
		...
		try {
			...
			stmt.executeQuery("insert into drivers values(" + (id + 1) + ",'" + dname + "'," + license + ",'" + gender
					+ "'," + contact + ")");
	...
	public void editDriver(String olddname, String newdname, long license, String gender, long contact) {
		...
		try {
			...
			stmt.executeUpdate("update drivers set driver_name='" + newdname + "',license_no=" + license + ",gender='"
					+ gender + "',contact=" + contact + " where driver_id=" + driverId + "");
	...
	public void addVehicle(String vname, long regno, int capacity, String vtype, String driver) {
		...
		try {
			...
			System.out.println(id);
			stmt.executeQuery("insert into vehicles values(" + (id + 1) + ",'" + vname + "'," + regno + "," + capacity
					+ ",'" + vtype + "'," + driverId + ")");
	...
	public void showErrorMessage(String message) {
		JOptionPane.showMessageDialog(new JFrame(), message, "Database Warning", JOptionPane.WARNING_MESSAGE);
