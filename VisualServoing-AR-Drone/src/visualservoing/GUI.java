...
public class GUI {
    ...
    private JLabel lblDroneStateValue;
    private ControlState droneState;
    private JLabel lblObjectTracked;
    private JLabel lblObjectTrackStatus,lblXaxisValue,lblYaxisValue,lblAreaValue,lblOrientationValue,lblAltitudeValue, lblSignalValue;
	/**
	...
	public void connectDrone()
	{
		try {
			...
			JOptionPane.showMessageDialog(null,
				    "Connection Failed.\n Make sure that drone is turned on and WiFi is connected",
				    "Connection Error",
